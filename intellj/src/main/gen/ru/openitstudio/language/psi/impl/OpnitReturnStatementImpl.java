...
public class OpnitReturnStatementImpl extends ASTWrapperPsiElement implements OpnitReturnStatement {

  public OpnitReturnStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
